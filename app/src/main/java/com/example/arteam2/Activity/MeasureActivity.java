            ...
            public void run() {
                switch (pointHandler.getMode()) {
                    ...
                    case FoundOrthoFloor:
                        if (pointHandler.getBoxHeight() != -1) {
                            /*numPointsView.setText("박스 높이 : " + (int) (pointHandler.getBoxHeight() * 100) + "cm\n"
                                    + "박스 width  : " + (int) (Math.lengthBetween(pointHandler.getPlaneObject().getll(), pointHandler.getPlaneObject().getlr()) * 100) + "cm"+ "\n"
                                    + "박스 length : " + (int) (Math.lengthBetween(pointHandler.getPlaneObject().getll(), pointHandler.getPlaneObject().getul()) * 100) + "cm");
                            numPointsView.setVisibility(View.VISIBLE);*/
                            ...
                            if(showResult == false) {
                                ...
                                float[] resultSize = new float[3];
                                resultSize[0] = (pointHandler.getBoxHeight() * 100);
                                resultSize[1] = (Math.lengthBetween(pointHandler.getPlaneObject().getll(), pointHandler.getPlaneObject().getlr()) * 100);
                                resultSize[2] = (Math.lengthBetween(pointHandler.getPlaneObject().getll(), pointHandler.getPlaneObject().getul()) * 100);
